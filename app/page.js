...
const categories = [
  { label: 'Kids Clothing',      desc: 'Newborn to 12 years',        color: 'bg-coral/20',   emoji: '👕', href: '/collections?cat=clothing' },
  { label: 'Kids Bedding',       desc: 'Single bed sets & covers',   color: 'bg-skyblue/30', emoji: '🛏️', href: '/collections?cat=bedding' },
  { label: 'Bags',               desc: 'School, college & baby bags', color: 'bg-sunny/40',   emoji: '🎒', href: '/collections?cat=bags' },
  { label: 'Little Accessories', desc: 'Pins, ponytails & more',     color: 'bg-mint/30',    emoji: '🎀', href: '/collections?cat=accessories' },
]
    ...
    <>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-10">
          ...
          <Link href="/collections" className="text-coral font-semibold hover:underline">
            See all →
          </Link>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
