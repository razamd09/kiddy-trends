...
export default function AdminProducts() {
    ...
    const COMMON_SIZES = ['0-3M','3-6M','6-9M','9-12M','1-2Y','2-3Y','3-4Y','4-5Y','5-6Y','6-7Y','7-8Y','8-9Y','9-10Y','10-11Y','11-12Y','12-13Y','XS','S','M','L','XL']
    ...
    return (
        <div className="min-h-screen bg-cream">
            ...
            <div className="bg-white shadow-sm px-6 py-4 flex items-center justify-between sticky top-0 z-10">
                ...
                <div className="flex items-center gap-3">
                    <Link href="/admin/products/bulk-product-upload" className="px-4 py-2 bg-indigo-600 text-white font-display text-sm rounded-full hover:bg-indigo-700">
                        🚀 Bulk Product Upload
                    </Link>
