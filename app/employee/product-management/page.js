...
const modules = [
    {
        ...
        description: 'Create, edit, duplicate, import, and update product records.',
    ...
    },
    {
        ...
        href: '/employee/product-brands',
        accent: 'bg-purple-500 text-white',
    },
]

export default function EmployeeProductManagementDashboard() {
    ...
    useEffect(() => {
        ...
        try {
            const nextEmployee = JSON.parse(stored)
            if (!nextEmployee?.employee_id) { router.push('/admin'); return }
            ...
            <div className="bg-white shadow-sm px-6 py-4 flex items-center justify-between sticky top-0 z-10">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400">{employee.name} · Products and product metadata</p>
                    </div>
                </div>
