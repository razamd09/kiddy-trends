...
// Shared with the webhook receiver (app/api/webhooks/postex/[secret]/route.js)
// so a pushed status update and a pulled one normalize identically.
export function normalizePostExStatus(statusValue) {
