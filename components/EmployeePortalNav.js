...
const menus = [
  { label: 'Dashboard', href: '/employee/dashboard' },
  {
    ...
    items: [
      ...
      { href: '/employee/product-categories', label: 'Categories' },
      { href: '/employee/product-versions', label: 'Versions' },
      { href: '/employee/product-fabrics', label: 'Fabrics' },
      { href: '/employee/product-types', label: 'Types' },
      { href: '/employee/product-brands', label: 'Brands' },
    ],
  },
